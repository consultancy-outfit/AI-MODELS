...
const agentIcons = [
  'https://cdn.lordicon.com/hqymfzvj.json',
  'https://cdn.lordicon.com/qhviklyi.json',
  'https://cdn.lordicon.com/lbjtvqiv.json',
  'https://cdn.lordicon.com/rmkpgtpt.json',
  'https://cdn.lordicon.com/yqzmiobz.json',
  'https://cdn.lordicon.com/lewtedlh.json',
];
  ...
  return (
    <SiteShell>
      <Container maxWidth="lg" sx={{ pb: 8 }}>
        {/* Hero Section */}
        <Box sx={{ mb: 8 }}>
          <Typography variant="h1" sx={{ fontFamily: 'var(--font-syne)', fontWeight: 700, fontSize: { xs: '2rem', md: '3rem' }, mb: 2 }}>
            AI Agents
          </Typography>
                    ...
                    >
                      <CardContent>
                        ...
                        <Button
                          ...
                          variant="contained"
                          fullWidth
                          sx={{ bgcolor: '#C8622A', '&:hover': { bgcolor: '#A85222' }, fontWeight: 600, py: 1 }}
                        >
                          Launch Agent
                        </Button>
                      </CardContent>
        ...
        <Box>
          ...
          <motion.div initial="hidden" whileInView="visible" variants={containerVariants} viewport={{ once: true }}>
            <Grid container spacing={2.5}>
              {newAgentsSuggested.map((suggested) => (
                  ...
                  >
                    <CardContent>
                      ...
                      <Button
                        ...
                        variant="contained"
                        size="small"
                        sx={{ bgcolor: '#C8622A', '&:hover': { bgcolor: '#A85222' } }}
                      >
                        Build This
                      </Button>
                    </CardContent>
