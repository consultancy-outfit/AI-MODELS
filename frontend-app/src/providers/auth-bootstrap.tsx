...
import { clearCredentials, hydrateAuth, setCredentials } from '@/store/slices/authSlice';
import type { AuthCredentials } from '@/interface';
import { AUTH_STORAGE_KEY } from '@/constants/strings';
...
export function AuthBootstrap({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (!raw) { dispatch(hydrateAuth(null)); return; }
