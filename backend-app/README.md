...
Create or edit `backend-app/.env` with your local values:
...
If you use MongoDB Atlas with a `mongodb+srv://` URI and Node shows `querySrv ECONNREFUSED`, keep `MONGODB_URI` as your Atlas string and set `MONGODB_DNS_SERVERS=8.8.8.8,1.1.1.1`.
